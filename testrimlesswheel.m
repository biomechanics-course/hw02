...
for i = 1:N
    [xnext, te, xs, ts, energies] = rimlesswheelstep(xnext);
...
% whether initial thetadot after N consecutive steps matches
% analytical solution
...
thetadotfinal = x0s(end,2); % thetadotplus for the step following all 
% simulated steps
